...
if ($i_like.hasClass("fa-heart") || $i_like.hasClass("fa-star") || $i_like.hasClass("fa-thumbs-up")){
                                      ...
                                      <div class="media-content">
                                          ...
                                          <nav class="level is-mobile">
                                              <div class="level-left">
                                                  ...
                                                  aria-label="heart" 
                                                  onclick="toggle_reaction('${post["_id"]}', 'heart')">
                                                  ...
                                                  class="level-item is-sparta" 
                                                  aria-label="star" 
                                                  onclick="toggle_reaction('${post["_id"]}', 'star')">
                                                  ...
                                                  class="level-item is-sparta" 
                                                  aria-label="thumbsup" 
                                                  onclick="toggle_reaction('${post["_id"]}', 'thumbsup')">
                                                  <span class="icon is-small"><i class="fa ${class_thumbsup}" 
                                                  aria-hidden="true"></i></span>&nbsp;<span class="like-num">${num2str(post["count_thumbsup"])}</span>
                                                  </a>
                                              </div>
